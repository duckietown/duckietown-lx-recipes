...
def update_landmark(particle, landmark, kp, des, sigma_observation, kp_to_measurement):
    ...
    if(new_landmark[0]==new_landmark[1]):
        print("new_land",new_landmark[0],new_landmark[1])
        print("land",landmark.x,landmark.y)
        print("robot",robot_x,robot_y)
        print("predicted_bearing",predicted_bearing)
        print("predicted_dist",predicted_dist)
        print("z",(dist, bearing))
        print("z_hat",(predicted_dist, predicted_bearing))
        print("K",K)
        print("old_landmark",old_landmark)
        raise Exception
